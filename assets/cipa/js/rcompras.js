...
$(document).ready(function(){
	...
	$("#GeneraReporte").click(function()
	{
		...
		if(finicial==""){
			...
			$("#mensaje").append("<div class='modal1'><div class='center1'> <center> <img src='http://www.apphoruscloud/sami/assets/images/gif-load.gif'> Generando Reporte...</center></div></div>");
			...
			$.post(currentLocation + '/GeneraReporte',
			{
				...
				function(data, textStatus) {
					...
					if(total=="0"){
						var nuevaFila =
						"<tr>"
						+"<td colspan=4><center>Rango de Fecha: "+finicial+" al "+ffinal+", Tipo de Documento: "+$('select#documento').val()+", No Existen Registros</center></td>"
						+"</tr>";
						$(nuevaFila).appendTo("#reportes tbody");
					}
					$("#mensaje").text("");
