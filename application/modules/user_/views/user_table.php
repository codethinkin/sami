      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Tablero | Usuarios </h3>
            <div class="box-tools">
              ...
              <button type="button" class="btn-sm  btn btn-success InviteUser" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Invitar Usuario</button>
              <?php } ?>
            </div>
          </div>
          <!-- /.box-header -->
