                            ...
                            <div class="box-body">
                              <div class="row">
                                <div class="form-group">
                                  <label class="control-label col-sm-2 thfont" for="">Titulo App:</label>
                                  <div class="col-sm-10">
                                ...
                                <div class="row">
                                  <div class="form-group col-md-2 col-sm-2  col-xs-2 dsize">
                                    <span for="exampleInputFile" class="thfont">URL Favicon: </span>
                                  </div>
                            ...
                            <div class="row">
                              <div class="">
                                <div class="form-group m-t-20">
                                  <label class="control-label col-sm-2 box-title thfont" for="">Configuración Servidor Correo</label>
                                  <div class="col-sm-10">
                                ...
                                <div id="phpmailer" style="display:<?php if(isset($result['mail_setting']) && $result['mail_setting']=='php_mailer'){echo "block";}else{ echo 'none'; }?>;" >
                                  <div class="form-group">
                                    <label class="control-label col-sm-2 thfont" for="">Empresa Nombre:</label>
                                    <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <input id="test2" type="checkbox" />Mostrar Contraseña
                                    </div>
                                  </div>
                                </div>
                                <div id="simplemail"  style="display:<?php if(isset($result['mail_setting']) && $result['mail_setting']=='simple_mail'){echo "block";}else{ echo 'none'; }?>;">
                                  <div class="form-group">
                                    <label class="control-label col-sm-2 thfont" for="">Nombre Compañia:</label>
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" name="company_name" id="company_name" value="<?php echo isset($result['company_name'])?$result['company_name'] :'';?>" placeholder="Enter Company Name">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label col-sm-2 thfont" for="EMAIL">Correo:</label>
                                    <div class="col-sm-10">
