    ...
    <div class="row">
						...
						<div class="col-md-6">
				          <div class="form-group">
				            ...
				            <select name="status" id="states" class="form-control">
		        			<option value="active" <?php echo (isset($userData->status) && $userData->status == 'active')?'selected':''; ?> >Activo</option>

		        			<option value="deleted" <?php echo (isset($userData->status) && $userData->status == 'deleted')?'selected':''; ?> >Inactivo</option>
						...
						<div class="col-md-6">
						  <div class="form-group">
						    ...
						    <input type="text" name="name" value="<?php echo isset($userData->name)?$userData->name:'';?>" class="form-control" placeholder="Nombre de Usuario">
						  </div>
						</div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php foreach($user_type as $option){  $sel='';if(strtolower($option->user_type)==strtolower($u_type)){$sel="selected";}
                if(strtolower($option->user_type) ){
              ?>
