<form role="form bor-rad" enctype="multipart/form-data" action="<?php echo base_url().'customers/add_edit'?>" method="post">
  <div class="box-body">
    <div class="row">
						...
						<div class="col-md-6">
						  <div class="form-group">
						    ...
						    <input type="text" name="name" value="<?php echo isset($userData->name)?$userData->name:'';?>" class="form-control" placeholder="Nombre Completo">
						  </div>
						</div>
        ...
        <?php } if(isset($userData)){ ?>
          ...
          <div class="col-md-6">
            ...
            <label for="">Confirmar Clave</label>
               <input type="Password" name="confirmPassword" class="form-control" value="" placeholder="Contraseña">
            </div>
          </div>
          <?php } ?>
        ...
        <div class="box-footer sub-btn-wdt">
          <button type="submit" name="edit" value="edit" class="btn btn-primary wdt-bg">Actualizar</button>
        </div>
              <!-- /.box-body -->
        <?php }else{?>
        <div class="box-footer sub-btn-wdt">
          <button type="submit" name="submit" value="add" class="btn btn-primary wdt-bg">Grabar</button>
        </div>
        <?php }?>
      </form>
